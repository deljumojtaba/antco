    ...
    <div className="min-h-screen flex flex-col items-center justify-between bg-gradient-to-br from-[#0a0a23] via-[#181830] to-[#1a1a40] text-white p-4 sm:p-8">
      <main className="flex-1 flex flex-col items-center justify-center w-full max-w-2xl mx-auto py-12 gap-10">
        ...
        <div className="flex flex-wrap gap-2 justify-center mt-4">
          ...
          <span className="bg-[#FF5E5E] bg-opacity-30 rounded px-3 py-1 text-xs font-mono">#Web3</span>
        </div>
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center mt-6">
          <a
            ...
            className="flex-1 rounded-full bg-[#229ED9] hover:bg-[#176ca1] transition-colors text-white font-semibold py-3 px-6 text-center shadow-lg flex items-center justify-center gap-2"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 rounded-full bg-[#22242A] hover:bg-[#444654] transition-colors text-white font-semibold py-3 px-6 text-center shadow-lg flex items-center justify-center gap-2"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 rounded-full bg-[#FFD600] hover:bg-[#bfa600] transition-colors text-black font-semibold py-3 px-6 text-center shadow-lg"
          >
            Trade on DEX
          </a>
        </div>
        <section className="mt-8 text-center max-w-xl mx-auto flex flex-col gap-8 w-full">
          ...
          <div className="rounded-2xl bg-white/10 border border-gray-700 shadow p-6 sm:p-8">
            ...
            <p className="text-base text-gray-200">
              $ANTCO is more than just a token—it&apos;s a movement to empower developers globally. By supporting $ANTCO, you&apos;re helping to build
              a fair, transparent, and collaborative ecosystem on Solana. Join our community and help shape the future of Web3 development!
            </p>
          </div>
        </section>
      </main>
